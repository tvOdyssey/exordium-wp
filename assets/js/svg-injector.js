        ...
        for (var e = function(e, n) {
            setTimeout(function() {
                if (Array.isArray(o[t])) {
                    var n = i.get(t)
                      , a = o[t][e];
                    (n instanceof SVGSVGElement || n instanceof HTMLElement) && a(null, r(n)),
                    n instanceof Error && a(n),
                    e === o[t].length - 1 && delete o[t]
                }
            }, 0)
        }, n = 0, a = o[t].length; n < a; n++)
            e(n)
    }, s = 0, c = [], u = {}, f = "http://www.w3.org/1999/xlink", d = function(t, e, o, d, p) {
        var v = t.getAttribute("data-src") || t.getAttribute("src");
        if (v && /\.svg/i.test(v)) {
            if (-1 !== c.indexOf(t))
                return c.splice(c.indexOf(t), 1),
                void (t = null);
            c.push(t),
            t.setAttribute("src", ""),
            function(t, e) {
                    ...
                    try {
                        if (4 === s.readyState) {
                            if (404 === s.status || null === s.responseXML)
                                throw new Error(n() ? "Note: SVG injection ajax calls do not work locally without adjusting security setting in your browser. Or consider using a local webserver." : "Unable to load SVG file: " + t);
                            if (!(200 === s.status || n() && 0 === s.status))
                                throw new Error("There was a problem injecting the SVG: " + s.status + " " + s.statusText);
                            s.responseXML instanceof Document && s.responseXML.documentElement && i.set(t, s.responseXML.documentElement),
                            l(t)
                        }
                    } catch (e) {
                        i.set(t, e),
                ...
                A && n.setAttribute("style", A),
                n.setAttribute("data-src", v);
                    ...
                    Object.keys(S).forEach(function(t) {
                        ...
                        for (var e = function(t, e) {
                            ...
                            for (var u = 0, d = o.length; u < d; u++)
                                o[u].setAttributeNS(f, "href", "#" + E);
                            b[t].id = E
                        }, r = 0, i = (b = n.querySelectorAll(t + "[id]")).length; r < i; r++)
                            e(r)
                    })
                }
                n.removeAttribute("xmlns:a");
                for (var x, j, k = n.querySelectorAll("script"), G = [], M = 0, T = k.length; M < T; M++)
                    (j = k[M].getAttribute("type")) && "application/ecmascript" !== j && "application/javascript" !== j && "text/javascript" !== j || ((x = k[M].innerText || k[M].textContent) && G.push(x),
                    n.removeChild(k[M]));
                if (G.length > 0 && ("always" === e || "once" === e && !u[v])) {
                    for (var V = 0, N = G.length; V < N; V++)
                        new Function(G[V])(window);
                    u[v] = !0
                }
            ...
            p(new Error("Attempted to inject a file with a non-svg extension: " + v))
    };
    ...
    t.SVGInjector = function(e, r) {
        ...
        if (e && "length"in e)
            for (var h = 0, g = 0, A = e.length; g < A; g++)
                d(e[g], f, v, c, function(t, r) {
                    l(t, r),
                    e && "length"in e && e.length === ++h && o(h)
                });
        else
            e ? d(e, f, v, c, function(t, r) {
                l(t, r),
                o(1),
                e = null
            }) : o(0)
